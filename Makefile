...
ACLOCAL = ${SHELL} /usr/local/src/soc-work/soc-mobin-new/missing --run aclocal-1.10
AMTAR = ${SHELL} /usr/local/src/soc-work/soc-mobin-new/missing --run tar
AUTOCONF = ${SHELL} /usr/local/src/soc-work/soc-mobin-new/missing --run autoconf
AUTOHEADER = ${SHELL} /usr/local/src/soc-work/soc-mobin-new/missing --run autoheader
AUTOMAKE = ${SHELL} /usr/local/src/soc-work/soc-mobin-new/missing --run automake-1.10
AWK = gawk
CC = gcc
...
LTLIBINTL = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /usr/local/src/soc-work/soc-mobin-new/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /usr/local/src/soc-work/soc-mobin-new
abs_srcdir = /usr/local/src/soc-work/soc-mobin-new
abs_top_builddir = /usr/local/src/soc-work/soc-mobin-new
abs_top_srcdir = /usr/local/src/soc-work/soc-mobin-new
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = $(SHELL) /usr/local/src/soc-work/soc-mobin-new/install-sh
...
EXTRA_DIST = src/gettext.h config.rpath m4/ChangeLog  AUTHORS COPYING ChangeLog INSTALL README TODO tuxtype.lsm tuxtype.spec tuxtype.spec.in config.h autorun.inf tuxtype.ico
