...
ACLOCAL = ${SHELL} /usr/local/src/soc-mobin-up/missing --run aclocal-1.10
AMTAR = ${SHELL} /usr/local/src/soc-mobin-up/missing --run tar
AUTOCONF = ${SHELL} /usr/local/src/soc-mobin-up/missing --run autoconf
AUTOHEADER = ${SHELL} /usr/local/src/soc-mobin-up/missing --run autoheader
AUTOMAKE = ${SHELL} /usr/local/src/soc-mobin-up/missing --run automake-1.10
AWK = mawk
CC = gcc
...
LTLIBINTL = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /usr/local/src/soc-mobin-up/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /usr/local/src/soc-mobin-up
abs_srcdir = /usr/local/src/soc-mobin-up
abs_top_builddir = /usr/local/src/soc-mobin-up
abs_top_srcdir = /usr/local/src/soc-mobin-up
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = $(SHELL) /usr/local/src/soc-mobin-up/install-sh
